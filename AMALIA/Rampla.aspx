<%@ Page Title="" Language="C#" EnableEventValidation="false" MasterPageFile="~/Amalia.Master" AutoEventWireup="true" CodeBehind="Rampla.aspx.cs" Inherits="AMALIA.Rampla" %>
                            ...
                            <div class="row">
                                <div class="col-lg-12 col-md-12 col-sm-12">
                                    <asp:UpdatePanel runat="server" ID="UP_NUEVO" UpdateMode="Conditional">
                                        ...
                                        <ContentTemplate>
                                            <span style="font-size: large"><strong>RAMPLAS</strong> </span>
                                            &nbsp;&nbsp; &nbsp;&nbsp;&nbsp;&nbsp; &nbsp;&nbsp;
                                            <asp:LinkButton ClientIDMode="AutoID" runat="server" ID="B_NUEVO" CssClass="btn btn-primary btn-sm" OnClick="B_NUEVO_Click"><i class="fa fa-pallet"></i>&nbsp;CREAR NUEVA RAMPLA</asp:LinkButton>
                                        ...
                                        <ContentTemplate>
                                            <asp:Panel runat="server" ID="PANEL_PRINCIPAL">
                                                <div class="body table-responsive">
                                                    <asp:GridView DataKeyNames="ID_RAMPLA, activo" ClientIDMode="AutoID" runat="server" ID="G_PRINCIPAL" CssClass="table table-bordered" OnRowCommand="G_PRINCIPAL_RowCommand" AutoGenerateColumns="false" ShowHeaderWhenEmpty="true">
                                                        ...
                                                        <Columns>
                                                            ...
                                                            <asp:BoundField HeaderText="ID_RAMPLA" DataField="ID_RAMPLA" Visible="false" />
                                            ...
                                            <asp:Panel runat="server" ID="PANEL_DETALLE1" Visible="false">
                                                <div class="body">
                                                    <div class="row">
                                                        <div class="col-sm-12">
                                                            <h2><strong>INFORMACION</strong> DE LA RAMPLA</h2>
                                                            <hr />
                                                            <form class="form-horizontal">
                                                                ...
                                                                <div class="row clearfix">
                                                                    ...
                                                                    <div class="col-lg-10 col-md-10 col-sm-8">
                                                                        <div class="form-group">
                                                                            <asp:TextBox runat="server" ID="T_NUM_CHASIS" CssClass="form-control amalia-control" placeholder="Ej: ZN-1744"></asp:TextBox>
                                                                        </div>
                                                                    </div>
                                                                </div>                                                               
                                                                <div class="row clearfix">
                                                                    ...
                                                                    <div class="col-lg-10 col-md-10 col-sm-8">
                                                                        <div class="form-group">
                                                                            <asp:TextBox runat="server" ID="T_MARCA" CssClass="form-control amalia-control" placeholder="ej: Freightliner"></asp:TextBox>
                                                                        </div>
                                                                    </div>
                                                                </div>
                                                                <div class="row clearfix">

...
namespace CRM
{
    ...
    public partial class Imprime_oc : System.Web.UI.Page
    {
        ...
        protected void Page_Load(object sender, EventArgs e)
        {
            ...
            try
            {
                ...
                try
                {
                    if (id_gt != "")
                    {
                        OBJ_OC_ENC lagt = new OBJ_OC_ENC();
                        lagt.ID_OC = int.Parse(id_gt);
                        FN_OC_ENC.LLENAOBJETO(ref lagt);
                        if (lagt._respok)
                        {
                            // DT
                            DataTable dt = FN_OC_ENC.getDetalleOC(lagt.ID_OC);
                            // INFO
                            ...
                            // AGREGAR LOGOS   
                            iTextSharp.text.Image imagen = creaimagen("~/logozamoraoc.jpg", 100, "i");
                            // PRIMERA IMAGEN
                            ...
                            agregacelda(ref tEncLeft, "76.686.770-7", _standardFont, 0, "i");

                            agregacelda(ref tEncLeft, "RAZON SOCIAL", _standardFont_bold, 0, "i");
                            agregacelda(ref tEncLeft, "SOC. COMERCIAL Y DE TRANSPORTES ZAMORA LTDA", _standardFont, 0, "i");

                            agregacelda(ref tEncLeft, "GIRO", _standardFont_bold, 0, "i");
                            agregacelda(ref tEncLeft, "TRANSPORTE", _standardFont, 0, "i");

                            agregacelda(ref tEncLeft, "DIRECCION", _standardFont_bold, 0, "i");
                            agregacelda(ref tEncLeft, "PETORQUITA #789", _standardFont, 0, "i");

                            agregacelda(ref tEncLeft, "CIUDAD", _standardFont_bold, 0, "i");
                            agregacelda(ref tEncLeft, "HIJUELAS", _standardFont, 0, "i");
                            ...
                            agregacelda(ref tEncright2, lagt.observacion, _standardFont, 1, "i");
                            ...
                            // TABLA AUTORIZADOS
                            // **************************************************************************************
                            PdfPTable tAUT = new PdfPTable(1);
                            ...
                            agregacelda(ref tAUT, "Autorización Francisca Estay", _standardFont_bold, 0, "c");

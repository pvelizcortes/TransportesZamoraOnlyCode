<%@ Page Title="" Language="C#" EnableEventValidation="false" MasterPageFile="~/Amalia.Master" AutoEventWireup="true" CodeBehind="Ordenes_Compra_Agro.aspx.cs" Inherits="AMALIA.Ordenes_Compra_Agro" %>
                            ...
                            <div class="row">
                                <div class="col-sm-12">
                                    <ul class="breadcrumb p-l-0 p-b-0 float-right">
                                        ...
                                        <li class="breadcrumb-item active">Ordenes de Compra Agro</li>
                                    </ul>
                                </div>
                            </div>
                            <div class="row">
                                    ...
                                    <asp:UpdatePanel runat="server" ID="UP_PRINCIPAL">
                                        ...
                                        <ContentTemplate>
                                            ...
                                            <asp:Panel runat="server" ID="PANEL_PRINCIPAL">
                                                <div class="row clearfix">
                                                    <div class="col-sm-12">
                                                        <asp:LinkButton CssClass="btn btn-sm btn-success" ClientIDMode="AutoID" runat="server" ID="B_NUEVO" OnClick="B_NUEVO_Click">
                                                                                <b><small>+ INGRESAR NUEVA ORDEN DE COMPRA</small></b>
                                                        </asp:LinkButton>
                                                        <asp:Label style="margin-left:20px" runat="server" Font-Bold="true" Font-Size="Large" Text=" (Ordenes de Compra Agro Comercial)"></asp:Label>
                                                    </div>
                                                </div>
                                                <hr />
                                                <div class="row clearfix">
                                                ...
                                                <div class="row clearfix">
                                                    <div class="col-sm-2">
                                                        <br />
                                                        <asp:LinkButton runat="server" ID="B_FILTRAR" ClientIDMode="AutoID" OnClick="B_FILTRAR_Click" CssClass="btn btn-success btn-sm btn-round"><i class="fa fa-search"></i> FILTRAR</asp:LinkButton>
                                                    </div>
                                                </div>
                                                <hr />
                                                <div class="row">
                                                    <div class="col-sm-12 table-responsive">
                                                        <asp:GridView DataKeyNames="id_oc, id_oc_det, correlativo_oc" ClientIDMode="AutoID" runat="server" ID="G_PRINCIPAL"
                                                            ...
                                                            <Columns>
                                                                ...
                                                                <asp:BoundField DataField="aprobado_fz" HeaderText="AUT F. ZAMORA" />
                                            ...
                                            <asp:Panel ID="PANEL_ENC" runat="server" Visible="false">
                                                <h4>
                                                    ...
                                                    <div class="btn btn-success  btn-sm" onclick="ImprimeOC2();"><i class="fa fa-print"></i>Imprimir OC</div>
                                                ...
                                                <form class="form-horizontal">
                                                    ...
                                                    <div class="row">
                                                        <div class="col-sm-12 text-right">
                                                            <asp:LinkButton ClientIDMode="AutoID" CssClass="btn btn-raised btn-success btn-round waves-effect" runat="server" ID="B_GUARDAROC" OnClick="B_GUARDAROC_Click"><i class="fa fa-save"></i>&nbsp;GUARDAR ORDEN DE COMPRA</asp:LinkButton>
                                            ...
                                            <asp:Panel ID="PANEL_DET" runat="server" Visible="false">
                                                ...
                                                <form class="form-horizontal">
                                                    ...
                                                    <div class="row">
                                                        ...
                                                        <div class="col-sm-4">
                                                            <small><b>Autorizado F. Zamora</b></small>
...
<asp:Content ID="Content2" ContentPlaceHolderID="CODIGO_JAVASCRIPT" runat="server">
    <script>
        ...
        function ImprimeOC(num_oc) {
            var win = window.open('Imprime_ocpv.aspx?num_oc=' + num_oc, '_blank');
            win.focus();
        }
        ...
        function SubirDocumento3() {
            ...
            if (files.length > 0) {
                ...
                var ajaxRequest = $.ajax({
                    type: "POST",
                    url: "SUBE_ARCHIVOS.aspx?tipo_doc=5&id_oc=" + id_oc + "&guid=" + guid_pro,
                    contentType: false,
                    processData: false,
                    data: data
                });

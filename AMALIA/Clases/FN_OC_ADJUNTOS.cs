...
namespace AMALIAFW
{
    ...
    public static class FN_OC_ADJUNTOS
    {
        ...
        public static void INSERT(ref OBJ_OC_ADJUNTOS objeto)
        {
            try
            {
                using (SqlConnection conn = new SqlConnection(connex))
        ...
        public static void UPDATE(ref OBJ_OC_ADJUNTOS objeto)
        {
            try
            {
                using (SqlConnection conn = new SqlConnection(connex))
        ...
        public static void DELETE(ref OBJ_OC_ADJUNTOS objeto)
        {
            try
            {
                using (SqlConnection conn = new SqlConnection(connex))
        ...
        public static void LLENAOBJETO(ref OBJ_OC_ADJUNTOS objeto)
        {
            try
            {
                using (SqlConnection conn = new SqlConnection(connex))
        ...
        public static void PREPARAOBJETO(ref OBJ_OC_ADJUNTOS objeto)
        {
            try
            {
                // **************************************** **************************************** **************************************** //  

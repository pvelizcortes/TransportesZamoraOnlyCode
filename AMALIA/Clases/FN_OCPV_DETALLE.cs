...
namespace AMALIAFW
{
    ...
    public static class FN_OCPV_DETALLE
    {
        ...
        public static void INSERT(ref OBJ_OCPV_DETALLE objeto)
        {
            try
            {
                using (SqlConnection conn = new SqlConnection(connex))
        ...
        public static void UPDATE(ref OBJ_OCPV_DETALLE objeto)
        {
            try
            {
                using (SqlConnection conn = new SqlConnection(connex))
        ...
        public static void DELETE(ref OBJ_OCPV_DETALLE objeto)
        {
            try
            {
                using (SqlConnection conn = new SqlConnection(connex))
        ...
        public static void LLENAOBJETO(ref OBJ_OCPV_DETALLE objeto)
        {
            try
            {
                using (SqlConnection conn = new SqlConnection(connex))
        ...
        public static void PREPARAOBJETO(ref OBJ_OCPV_DETALLE objeto)
        {
            try
            {
                // **************************************** **************************************** **************************************** //  

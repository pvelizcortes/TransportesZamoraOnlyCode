...
namespace AMALIAFW
{
    ...
    public static class FN_RAMPLA
    {
        public static string connex = ConfigurationManager.ConnectionStrings["default"].ToString();

        // CAMBIAR AQUI //
        // **************************************** **************************************** **************************************** //       
        private static string nombre_tabla = "rampla";
        private static string nombre_llave = "ID_RAMPLA";
        private static string value_insert = " patente, num_chasis, marca, ano, carga, activo ";
        private static string value_insert2 = " @patente, @num_chasis, @marca, @ano, @carga, @activo ";
        ...
        public static void INSERT(ref OBJ_RAMPLA objeto)
        {
            try
            {
                using (SqlConnection conn = new SqlConnection(connex))
        ...
        public static void UPDATE(ref OBJ_RAMPLA objeto)
        {
            try
            {
                using (SqlConnection conn = new SqlConnection(connex))
                {
                    ...
                    using (SqlCommand cmd = new SqlCommand(sql, conn))
                    {
                        ...
                        cmd.Parameters.AddWithValue("@" + nombre_llave, objeto.ID_RAMPLA);
                        // **************************************** **************************************** **************************************** //                       
        ...
        public static void DELETE(ref OBJ_RAMPLA objeto)
        {
            try
            {
                using (SqlConnection conn = new SqlConnection(connex))
        ...
        public static void LLENAOBJETO(ref OBJ_RAMPLA objeto)
        {
            try
            {
                using (SqlConnection conn = new SqlConnection(connex))
        ...
        public static void PREPARAOBJETO(ref OBJ_RAMPLA objeto)
        {
            try
            {
                // **************************************** **************************************** **************************************** //  

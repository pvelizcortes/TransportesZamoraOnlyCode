...
namespace AMALIAFW
{
    public class OBJ_HALLAZGOS_ADJUNTOS
    {
    ...
    public static class FN_HALLAZGOS_ADJUNTOS
    {
        public static string connex = ConfigurationManager.ConnectionStrings["default"].ToString();

        private static string nombre_tabla = "HALLAZGOS_ADJUNTOS";
        private static string nombre_llave = "ID_DOC";
        private static string value_insert = "id_hallazgo, nom_archivo, nom_real, fecha";
        private static string value_insert2 = "@id_hallazgo, @nom_archivo, @nom_real, @fecha";
        private static string value_update = "id_hallazgo = @id_hallazgo, " +
        ...
        public static void INSERT(ref OBJ_HALLAZGOS_ADJUNTOS objeto)
        {
            try
            {
                using (SqlConnection conn = new SqlConnection(connex))
                {
                    ...
                    using (SqlCommand cmd = new SqlCommand(sql, conn))
                    {
                        ...
                        cmd.Parameters.AddWithValue("@id_hallazgo", objeto.id_hallazgo);
        ...
        public static void UPDATE(ref OBJ_HALLAZGOS_ADJUNTOS objeto)
        {
            try
            {
                using (SqlConnection conn = new SqlConnection(connex))
        ...
        public static void DELETE(ref OBJ_HALLAZGOS_ADJUNTOS objeto)
        {
            try
            {
                using (SqlConnection conn = new SqlConnection(connex))
        ...
        public static void LLENAOBJETO(ref OBJ_HALLAZGOS_ADJUNTOS objeto)
        {
            try
            {
                using (SqlConnection conn = new SqlConnection(connex))
                {
                    ...
                    {
                        //  nombre_cliente, razon_social, correo, direccion, telefono, nombre_encargado, activo 
                        objeto.id_hallazgo = int.Parse(reader["id_hallazgo"].ToString());
        ...
        public static void PREPARAOBJETO(ref OBJ_HALLAZGOS_ADJUNTOS objeto)
        {
            try
            {
                // **************************************** **************************************** **************************************** //  
                objeto.id_hallazgo = 0;
                objeto.nom_archivo = " ";
                objeto.nom_real = " ";

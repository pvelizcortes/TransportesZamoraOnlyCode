<%@ Page Title="" Language="C#" EnableEventValidation="false" MasterPageFile="~/Amalia.Master" AutoEventWireup="true" CodeBehind="Obra.aspx.cs" Inherits="AMALIA.Obra" %>
                            ...
                            <div class="row">
                                <div class="col-lg-12 col-md-12 col-sm-12">
                                    <asp:UpdatePanel runat="server" ID="UP_NUEVO" UpdateMode="Conditional">
                                        ...
                                        <ContentTemplate>
                                            <span style="font-size: large"><strong>OBRAS</strong> </span>
                                            &nbsp;&nbsp; &nbsp;&nbsp;&nbsp;&nbsp; &nbsp;&nbsp;
                                            <asp:LinkButton ClientIDMode="AutoID" runat="server" ID="B_NUEVO" CssClass="btn btn-primary btn-sm" OnClick="B_NUEVO_Click"><i class="fa fa-map-marker-alt"></i>&nbsp;CREAR NUEVA OBRA</asp:LinkButton>
                                        ...
                                        <ContentTemplate>
                                            <asp:Panel runat="server" ID="PANEL_PRINCIPAL">
                                                <div class="body table-responsive">
                                                    <asp:GridView DataKeyNames="ID_OBRA " ClientIDMode="AutoID" runat="server" ID="G_PRINCIPAL" CssClass="table table-bordered" OnRowCommand="G_PRINCIPAL_RowCommand" AutoGenerateColumns="false" ShowHeaderWhenEmpty="true">
                                                        ...
                                                        <Columns>
                                                            ...
                                                            <asp:BoundField HeaderText="ID_OBRA" DataField="ID_OBRA" Visible="false" />
                                            ...
                                            <asp:Panel runat="server" ID="PANEL_DETALLE1" Visible="false">
                                                <div class="body">
                                                    <div class="row">
                                                        <div class="col-sm-12">
                                                            <h2><strong>INFORMACION</strong> DE LA OBRA</h2>
                                                            <hr />
                                                                ...
                                                                <div class="row clearfix">
                                                                    ...
                                                                    <div class="col-lg-10 col-md-10 col-sm-8">
                                                                        <div class="form-group">
                                                                            <asp:TextBox runat="server" ID="T_CLIENTE" CssClass="form-control amalia-control" placeholder=""></asp:TextBox>
                                                                        </div>
                                                                    </div>
                                                                </div>
                                                                <div class="row clearfix">
                                                                    ...
                                                                    <div class="col-lg-10 col-md-10 col-sm-8">
                                                                        <div class="form-group">
                                                                            <asp:TextBox runat="server" ID="T_OBRA" CssClass="form-control amalia-control" placeholder=""></asp:TextBox>
                                                                        </div>
                                                                    </div>
                                                                </div>                                                                                                                             
                                                                <div class="row clearfix">

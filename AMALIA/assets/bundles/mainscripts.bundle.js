...
$(function() {
    "use strict";
    $.AdminInfiniO.browser.activate(), $.AdminInfiniO.leftSideBar.activate(), $.AdminInfiniO.rightSideBar.activate(), $.AdminInfiniO.rightchat.activate(), $.AdminInfiniO.navbar.activate(), setTimeout(function() {
...
"Netscape" == navigator.appName && document.captureEvents(Event.MOUSEDOWN || Event.MOUSEUP), document.onmousedown = mousehandler, document.onmouseup = mousehandler, $(function() {
    "use strict";
